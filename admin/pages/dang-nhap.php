...
<head>
    ...
    <title>Đăng nhập tài khoản- &copy; Bloggame</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><a href="index.html"><img class="logo-img" src="../../assets/images/logo.png" width="100%" alt="logo"></a><span class="splash-description">Đăng nhập tài khoản</span></div>
            <div class="card-body">
                <form method="POST">
