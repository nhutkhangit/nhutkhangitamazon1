...
<body>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                     <h5 class="card-header" style="font-family: 'Roboto Condensed', sans-serif;">Đơn hàng chờ xác nhận</h5>
                                <div class="card-body">
    ...
    ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="chi-tiet-don-hang.php?code_invoice=<?php echo $row_invoice['code_invoice']; ?>" class="btn btn-outline-info" title="Xem chi tiết đơn hàng">
                                                            Chi tiết
                                                        </a>
                                                    </td>
                                                </tr>
