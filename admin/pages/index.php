<?php
    ...
    if(isset($_SESSION['user']) && isset($_SESSION['level']))
    {
        ...
        // product
        $product = "SELECT count(sku_product) as tong_san_pham FROM product";
...
<body>
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="ecommerce-widget">
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card" id="text">
                                    <h5 class="card-header" style="font-family: 'Roboto Condensed', sans-serif;">Thông tin về niên luận</h5>
                                    <div class="card-body">
                                        <p class="lead">Họ tên sinh viên: Đào Thanh Huy (MSSV: 1602206015)<br/>
                                            Giảng viên hướng dẫn: Ths.Nhan Thanh Nhã
                                        </p>
                                        <p> Thời gian bắt đầu: 12/07/2019 <br/>
                                            Ngày kết thúc: ../../2019
                                        </p>
                                        <p>
                                            <h5 style="font-family: 'Roboto Condensed', sans-serif;">1. Đôi nét về sản phẩm:</h5>
                                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Website bán hàng (Quần áo trẻ em) được em xây dựng dựa trên các <b> tham khảo </b> từ dự án thực tế và đã có chỉnh sửa, bổ sung thêm vài chức năng cần thiết cho người dùng. Sản phẩm này em đã thay đổi các thao tác trở nên cơ bản hơn với mục đích mang đến sự dễ dàng cho người sử dụng cũng như là gần gũi hơn với khách hàng. Bên cạnh đó em cũng chú trọng hơn về ngoại hình (giao diện) của website để tô thêm vẻ đẹp thương hiệu khách hàng. <br/><br/>
                                            <h5 style="font-family: 'Roboto Condensed', sans-serif;">1. Chức năng của website:</h5>
                                            - Thống kê. <br/>
                                            - <b> Resposive phù hợp với tất cả các thiết bị </b> </br/>
                                            - <b> Chỉnh sửa giao diện / thông tin trên website. </b> <br/>
                                            - Thêm, sửa, xóa loại sản phẩm. </br/>
                                            - Thêm, sửa, xóa sản phẩm. </br/>
                                            - Tìm kiếm sản phẩm. </br/>
                                            - Thêm, sửa, xóa loại bài viết (blog). </br/>
                                            - Thêm, sửa, xóa bài viết (blog). </br/>
                                            - Nhập kho. </br/>
                                            - Số lượng tồn trong kho. </br/>
                                            - Đặt hàng. </br/>
                                            - Xét duyệt đơn hàng. </br/>
                                            - Đơn hàng đang vận chuyển. </br/>
                                            - Đơn hàng đã bị thu hồi. </br/>
                                            - Đơn hàng vận chuyển thành công. </br/>
                                            - Đăng nhập Quản trị / Khách hàng. </br/>
                                            - Đăng ký Quản trị / Khách hàng. </br/>
                                            - Đổi mật khẩu quản trị </br/>
                                            - <b> Đếm số lượt xem blog / Sản phẩm </b> </br/>
                                            - Phân quyền cho người dùng. </br/>
                                            - <b> Bình luận vào bài viết(blog) / sản phẩm </b> </br/>
                                            - <b> Lịch sử thao tác </b> </br/>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted" style="font-family: 'Roboto Condensed', sans-serif;">Tổng số sản phẩm</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo number_format($tong_san_pham); ?></h1>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted" style="font-family: 'Roboto Condensed', sans-serif;">Tài khoản khách hàng</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo number_format($tong_customer); ?></h1>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header" style="font-family: 'Roboto Condensed', sans-serif;">Đơn hàng trong ngày
                                        <a href="don-hang.php" class="btn btn-outline-info float-right">
                                            Xử lý đơn hàng
                                        </a>
                                    </h5>
                                            ...
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0" style="font-family: 'Roboto Condensed', sans-serif;">Tổng tiền</th>
    ...
    <?php
        // invoice
        $invoice = "SELECT code_invoice, name, order_date, flag FROM invoice inv, account a WHERE inv.id_customer = a.id_acc ORDER BY order_date DESC";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php
                                                                ...
                                                                {
                                                                    echo "<span class='badge-dot badge-brand mr-1'></span>Đang vận chuyển";
                                                                }
                                                                else if($row_invoice['flag'] == 2)
                                                                {
                                                                    echo "<span class='badge-dot badge-success mr-1'></span>Vận chuyển thành công";
                                                                }
