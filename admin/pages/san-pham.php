                ...
                <div class="container-fluid dashboard-content " >
                    ...
                    <div class="ecommerce-widget">
                        <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header" style="font-family: 'Roboto Condensed', sans-serif;">Danh sách sản phẩm
                                    <div class="btn_function float-right">
                                        <a href='upload-san-pham.php' class='btn btn-outline-primary'><i class='fas fa-plus'></i> Sản phẩm</a>
                                    </div>
                                </h5>
                                <div class="card-body">
                        ...
                        <?php 
                            ...
                            if($level == 1)
                            {
                                $product = "SELECT sku_product, image, name_product, date_upload, p.slug as slug, typename, flag FROM product p, type_product tp WHERE p.id_type = tp.id_type ORDER BY date_upload DESC";
                        ...
                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="m-r-10">
                                                            <a href="anh-san-pham.php?id=<?php echo $row_product['sku_product']; ?>" title="Click để thêm ảnh sản phẩm">
                                                    ...
                                                    <td><?php echo $row_product['slug']; ?></td>
                                                    ...
                                                    <td>
                                                        <div class="m-r-10">
                                                            <?php
                                                                ...
                                                                {
                                                                    echo "<a href='anh-san-pham.php?id=".$row_product2['sku_product']."' title='Click để thêm ảnh sản phẩm'>
