<?php
    ...
    // Featured article
    $data1 = "SELECT * FROM blog WHERE flag = 1 AND highlight = 1 ORDER BY date_upload DESC LIMIT 3";
    ...
    // new post
    $data2 = "SELECT * FROM blog WHERE flag = 1 AND id_blog <> 29 AND id_blog <> 30 ORDER BY date_upload DESC";
