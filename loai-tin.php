<?php
  ...
  {
    $id_type = $_GET['type'];
    $type = "SELECT * FROM type_blog WHERE id_type = $id_type";
    ...
    $sql = "SELECT count(id_blog) as total FROM blog WHERE id_type = $id_type and flag = 1";
    ...
    $data = "SELECT * FROM blog WHERE flag = 1 and id_type = $id_type ORDER BY date_upload DESC LIMIT $start, $limit";
